...
public class BlinkToRadioMsg extends net.tinyos.message.Message {
    ...
    public String toString() {
      ...
      try {
        s += "  [txnodeid=0x"+Long.toHexString(get_txnodeid())+"]\n";
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: txnodeid
    ...
    /**
     * Return whether the field 'txnodeid' is signed (false).
     */
    public static boolean isSigned_txnodeid() {
        return false;
    }

    /**
     * Return whether the field 'txnodeid' is an array (false).
     */
    public static boolean isArray_txnodeid() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'txnodeid'
     */
    public static int offset_txnodeid() {
        return (0 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'txnodeid'
     */
    public static int offsetBits_txnodeid() {
        return 0;
    }

    /**
     * Return the value (as a int) of the field 'txnodeid'
     */
    public int get_txnodeid() {
        return (int)getUIntBEElement(offsetBits_txnodeid(), 16);
    }

    /**
     * Set the value of the field 'txnodeid'
     */
    public void set_txnodeid(int value) {
        setUIntBEElement(offsetBits_txnodeid(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'txnodeid'
     */
    public static int size_txnodeid() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'txnodeid'
     */
    public static int sizeBits_txnodeid() {
        return 16;
    }
